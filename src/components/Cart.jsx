...
const Cart = () => {
  ...
  return (
    ...
    <>
        <div className={`fixed right-0 top-0 w-full lg:w-[20vw] p-5 bg-white h-full mb-3 ${ activeCart ? "translate-x-0" : "translate-x-full"} transition-all duration-500 z-50`}>
            ...
            <div className='absolute bottom-0'>
                ...
                <button onClick={() => navigate("/success")} className='bg-green-500 px-3 font-normal text-white py-2 rounded-lg w-[90vw] lg:w-[18vw] mb-5'>Checkout</button>
            </div>
        </div>
